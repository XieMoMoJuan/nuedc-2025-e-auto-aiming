...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_0_PIN)) : (DL_GPIO_clearPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_1_PIN)) : (DL_GPIO_clearPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_2_PIN)) : (DL_GPIO_clearPins(GRY_READ_GRP_PORT,GRY_READ_GRP_ADDR_2_PIN)))// 地址位2控制
...
void No_MCU_Ganv_Sensor_Init(No_MCU_Sensor* sensor);// 带校准参数的初始化
#ifndef Use_Timer
// 任务处理函数
