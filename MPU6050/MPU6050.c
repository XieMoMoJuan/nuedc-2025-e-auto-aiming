...
返回  值：无
**************************************************************************/
#define GYRO_SENSITIVITY 16.4f  // for ±2000°/s
void Read_DMP(void)
{	
    ...
    {    
        ...
        mpu6050.roll = Pitch;
        mpu6050.yaw = Yaw;
        mpu6050.gyro.x = gyro[0] / GYRO_SENSITIVITY;
        mpu6050.gyro.y = gyro[1] / GYRO_SENSITIVITY;
        mpu6050.gyro.z = (0.7f)*mpu6050.gyro.z + (0.3f)*gyro[2] / GYRO_SENSITIVITY;
